...
import me.taplika.features_core.data.AdReporter
...
class ReviewFlow(private val activity: Activity, parentView: View) {
    ...
    private val adReporter: AdReporter = AdReporter(activity)
...
//            adReporter.reportAdEvent("review", ratingBar.rating.toString())
